 ...
 * size. If the allocation fails, the game module
 * is notified and /should/ correctly handle it.
 ...
 * fails, the game module is notified and /should/
 * correctly handle it. If amount or size equals 0
